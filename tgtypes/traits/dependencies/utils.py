...
from tgtypes.traits.dependencies.models import Dependant
    ...
    *,
    ...
    for param_name, param in signature_params.items():
        ...
        if param_name in path_param_names:
            ...
            add_param_to_fields(field=param_field, dependant=dependant)
        elif isinstance(param.default, (params.Query, params.Header)) and is_scalar_sequence_field(
            param_field
        ):
            add_param_to_fields(field=param_field, dependant=dependant)
        else:
...
async def solve_dependencies(
    *,
    ...
    for sub_dependant in dependant.dependencies:
        ...
        sub_dependant.cache_key = cast(Tuple[Callable, Tuple[str]], sub_dependant.cache_key)
